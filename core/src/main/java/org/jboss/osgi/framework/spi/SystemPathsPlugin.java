...
public interface SystemPathsPlugin extends Service<SystemPathsPlugin> {
    ...
    String[] DEFAULT_FRAMEWORK_PACKAGES = new String[]{
            ...
            "org.jboss.osgi.framework;version=3.0",
            "org.jboss.osgi.metadata;version=3.0",
        	"org.jboss.osgi.resolver;version=4.0",
        	"org.jboss.osgi.resolver.spi;version=4.0",
            "org.jboss.osgi.spi;version=4.0",
            "org.jboss.osgi.vfs;version=2.0",
